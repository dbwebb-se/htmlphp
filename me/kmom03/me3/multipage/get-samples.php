...
<p>Here are a few samples on how to use ? to send parameters to a webpage through the querysting.</p>

<ul id="list-lime">
    <li><a class="list-link-lime" href="?page=print-get&amp;parameter1=value1">parameter1=value1</a></li>
